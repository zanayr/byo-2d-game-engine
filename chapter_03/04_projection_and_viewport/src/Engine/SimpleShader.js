...
function SimpleShader(vertextShaderID, fragmentShaderID) {
  ...
  this.mShaderVertexPositionAttribute = null; // reference to ShaderVertexPosition in vertex shader
  this.mPixelColor = null; // reference to the uPixelColor uniform in the fragment shader
  this.mModelTransform = null; // reference to the uModelTransform uniform in the vertex shader
  ...
  // Step G: Get references to uniform variables
